"""Prompt templates package — re-exports everything for backward compatibility."""

from .system import SYSTEM_V2, CROSS_LINK_SECTION
from .update import UPDATE_PAGE_V2
